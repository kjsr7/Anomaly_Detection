...
for iv in range(nVideos):
	...
	print(aa)
#	print(predictions)
#	print(isinstance(predictions,dict))
#	print(isinstance(predictions,list))
#	print(predictions[0])	
	aa=aa[0:-4]
	...
	print(x)
	print(predictions)
	savemat(A_predictions_path, mdict={'x':x})
